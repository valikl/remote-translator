...
#include "../../TT_RemoteTranslation/sounddevices.h"
...
int SoundDevices::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: on_DirectSoundButton_toggled((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 1: on_ActSDButton_accepted(); break;
        case 2: on_SelfTestButton_clicked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: on_ActSDButton_rejected(); break;
        default: ;
        }
        _id -= 4;
    }
